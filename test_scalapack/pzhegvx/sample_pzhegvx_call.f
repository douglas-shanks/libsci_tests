...
*     May 10, 1996
*
*     This routine contains a sample call to PZHEGVX.
...
*     .. Local Arrays ..
     ...
     $                   IWORK( LIWORK )
      ...
      COMPLEX*16         A( LDA, LDA ), B( LDA, LDA ), WORK( LWORK ),
     $                   Z( LDA, LDA )
*     ..
*     .. External Subroutines ..
      EXTERNAL           BLACS_EXIT, BLACS_GET, BLACS_GRIDEXIT,
     $                   BLACS_GRIDINFO, BLACS_GRIDINIT, BLACS_PINFO,
     $                   BLACS_SETUP, DESCINIT, PZHEGVX, PZLAMODHILB,
     $                   PZLAPRNT, PZLATOEPLITZ
*     ..
...
*
      ...
      CALL PZLATOEPLITZ( N, B, 1, 1, DESCB, INFO )
*
*
...
*
*
*     Ask PZHEGVX to compute the entire eigendecomposition
*
      IBTYPE = 1
      CALL PZHEGVX( IBTYPE, 'V', 'A', 'U', N, A, 1, 1, DESCA, B, 1, 1,
...
*
      CALL PZLAPRNT( N, N, Z, 1, 1, DESCZ, 0, 0, 'Z', 6, WORK )
*
*
...
*
      ...
      END
*
      SUBROUTINE PZLATOEPLITZ( N, A, IA, JA, DESCA, INFO )
*
*  -- ScaLAPACK routine (version 1.2) --
*     University of Tennessee, Knoxville, Oak Ridge National Laboratory,
*     and University of California, Berkeley.
...
*
      DO 20 J = 1, N
         DO 10 I = 1, N
            CALL PZELSET( A, I, J, DESCA, DCMPLX( N-ABS( I-J ) ) )
   10    CONTINUE
   20 CONTINUE
*
*
...
*
      DO 20 J = 1, N
         DO 10 I = 1, N
            IF( I.EQ.J ) THEN
               CALL PZELSET( A, I, J, DESCA,
     $                       DCMPLX( ONE / ( DBLE( I+J )-ONE ) )+
     $                       DCMPLX( ONE ) )
            ELSE
               CALL PZELSET( A, I, J, DESCA,
     $                       DCMPLX( ONE / ( DBLE( I+J )-ONE ),

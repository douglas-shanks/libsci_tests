...
*     May 10, 1996
*
*     This routine contains a sample call to PDSYGVX.
...
*     .. Local Arrays ..
     ...
     $                   IWORK( LIWORK )
      DOUBLE PRECISION   A( LDA, LDA ), B( LDA, LDA ), GAP( MAXPROCS ),
     $                   W( MAXN ), WORK( LWORK ), Z( LDA, LDA )
*     ..
*     .. External Subroutines ..
      EXTERNAL           BLACS_EXIT, BLACS_GET, BLACS_GRIDEXIT,
     $                   BLACS_GRIDINFO, BLACS_GRIDINIT, BLACS_PINFO,
     $                   BLACS_SETUP, DESCINIT, PDLAMODHILB, PDLAPRNT,
     $                   PDLATOEPLITZ, PDSYGVX
*     ..
...
*
      ...
      CALL PDLATOEPLITZ( N, B, 1, 1, DESCB, INFO )
*
*
...
*
*
*     Ask PDSYGVX to compute the entire eigendecomposition
*
      IBTYPE = 1
      CALL PDSYGVX( IBTYPE, 'V', 'A', 'U', N, A, 1, 1, DESCA, B, 1, 1,
     $              DESCB, ZERO, ZERO, THIRT, MTHIRT, MONE, M, NZ, W,
     $              MONE, Z, 1, 1, DESCZ, WORK, LWORK, IWORK, LIWORK,
...
*
      ...
      END
*
      SUBROUTINE PDLATOEPLITZ( N, A, IA, JA, DESCA, INFO )
*
*  -- ScaLAPACK routine (version 1.2) --
*     University of Tennessee, Knoxville, Oak Ridge National Laboratory,
*     and University of California, Berkeley.
...
*
      DO 20 J = 1, N
         DO 10 I = 1, N
            CALL PDELSET( A, I, J, DESCA, DBLE( N-ABS( I-J ) ) )
   10    CONTINUE
   20 CONTINUE
*
*
